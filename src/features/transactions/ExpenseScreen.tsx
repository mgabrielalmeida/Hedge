      ...
      >
        ...
        <Card elevated>
          <View style={styles.form}>
            ...
            {kind === 'expense' ? <><Text tone="muted" variant="caption">Categoria</Text><View style={styles.choices}>{categories.map((category) => <Choice key={category.id} label={`${category.visualType === 'icon' ? category.visualValue : '●'} ${category.name}`} onPress={() => setCategoryId(category.id)} selected={categoryId === category.id} />)}</View></> : null}
